    ...
    return (
        <ul className={`space-x-5 align-baseline flex flex-wrap`}>
            <li onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} className="relative">
                <button className="body-text hover:cursor-pointer">Blogs</button>
                {showPopover && (
                        ...
                        <ul className="w-full">
                            <li className="py-1 whitespace-nowrap">
                                <Link href="/healing-journey" onClick={handleMouseLeave}>
                                    <div className="body-text hover:text-primary">Lou&apos;s Healing Journey</div>
                                </Link>
                            </li>
                            <li className="py-1 whitespace-nowrap" onClick={handleMouseLeave}>
                                <Link href="/additional-topics">
                                    <div className="body-text hover:text-primary">Additional Topics</div>
                                </Link>
                            </li>
                            <li className="py-1 whitespace-nowrap" onClick={handleMouseLeave}>
                                <Link href="/messages-for-humanity">
                                    <div className="body-text hover:text-primary">Messages for Humanity</div>
                                </Link>
                            </li>
                        </ul>
                    </div>
            ...
            <Link href="/resources">
                <div className="body-text hover:text-primary">Resources</div>
            </Link>
            <Link href={"/photos"}>
                <div className="body-text hover:text-primary">Photos</div>
            </Link>
        </ul>
    );
}