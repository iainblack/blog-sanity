    ...
    return (
        <div className="flex items-center gap-4 py-3">
            ...
            <span className="text-gray-600">
                Page <strong className="text-gray-800">{active + 1}</strong> of <strong className="text-gray-800">{totalPages}</strong>
            </span>
            <button
                className={`p-2 rounded-full border ${active + 1 === totalPages ? 'opacity-50 cursor-not-allowed' : 'hover:bg-gray-100'}`}
                onClick={next}
