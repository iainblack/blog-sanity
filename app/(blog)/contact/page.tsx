...
export default function Page() {
    const subtitle1 = `If you have a question or comment, I invite you to send it to me via this email link. I will do my best to respond promptly to each email message I receive.`;
